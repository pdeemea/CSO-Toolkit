...
def orchestrator(options):
    ...
    table_list = initialize(dburl, options.metadatatable, tables, stables)
    process_all_tables(table_list, options.nthreads, dburl, options.stat_mem, options.metadatatable)
